...
<body class="bg-gradient-to-br from-red-50 via-white to-red-100 flex items-center justify-center min-h-screen font-sans">
    <div class="bg-white shadow-2xl rounded-2xl p-8 max-w-md w-full text-center relative overflow-hidden">
        <!-- Decorative top bar -->
        <div class="absolute inset-x-0 top-0 h-2 bg-gradient-to-r from-red-600 to-black rounded-t-2xl"></div>
        ...
        <!-- Title -->
        <h1 class="text-3xl font-extrabold text-red-700 mb-2">Connected Successfully!</h1>
        <p class="text-gray-600 mb-6 leading-relaxed">
            Your <span class="font-semibold text-red-700">HeadHunter</span> account has been connected.
        ...
        <a href="https://vacancies.inter-ai.uz/"
           target="_blank"
           class="inline-block bg-red-600 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-red-700 hover:shadow-xl transition transform hover:scale-105">
            Go to Dashboard
        </a>
        ...
        <div class="absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r from-black to-red-600 rounded-b-2xl"></div>
    </div>
