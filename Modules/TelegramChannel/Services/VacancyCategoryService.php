...
class VacancyCategoryService
{
    ...
    private array $keywordBuckets = [
        'marketing_and_advertising' => ['marketing', 'advertising', 'таргет', 'smm', 'seo', 'ppc', 'brand', 'growth marketing', 'performance marketing', 'media buying', 'campaign management'],
        'sales_and_customer_relations' => ['sales', 'sale', 'продаж', 'продажи', 'sotuv', 'account manager', 'client manager', 'bizdev', 'crm', 'pipeline', 'customer success', 'partnerships'],
        'it_and_software_development' => ['developer', 'programmer', 'software', 'dasturchi', 'разработчик', 'backend', 'frontend', 'fullstack', 'mobile', 'node', 'nestjs', 'express', 'spring boot', 'django', 'flask', 'laravel', 'symfony', 'rails', 'react', 'vue', 'angular', 'kotlin', 'swift', 'unity', 'unreal', 'golang', 'rust', 'typescript', 'salesforce', 'sap', '1c', 'shopify', 'crm', 'bitrix'],
        ...
        'product_and_project_management' => ['product manager', 'project manager', 'scrum', 'kanban', 'product owner', 'pm', 'roadmap', 'backlog', 'program manager', 'delivery manager', 'agile coach'],
        ...
        'content_and_copywriting' => ['copywriter', 'content', 'editor', 'журналист', 'контент', 'technical writer', 'blogger', 'storytelling', 'seo copywriting'],
        'video_and_multimedia_production' => ['video', 'motion', 'premiere', 'after effects', 'montaj', 'видео', 'davinci resolve', 'cinema 4d', 'blender', 'storyboard', 'montajor'],
        'photography' => ['photo', 'photography', 'фото', 'photographer', 'lightroom', 'retouch', 'studio shoot', 'camera'],
        'human_resources_and_recruitment' => ['hr', 'recruiter', 'talent', 'кадры', 'hr manager', 'people partner', 'talent partner', 'people ops', 'compensation'],
        'finance_and_accounting' => ['finance', 'accounting', 'accountant', 'бухгалтер', 'financial', 'audit', 'treasury', 'tax', 'controller', 'payroll', 'budgeting'],
        'banking_and_insurance' => ['bank', 'credit', 'loan', 'insurance', 'страхование', 'банк', 'microfinance', 'underwriting', 'fintech', 'payments', 'merchant', 'kpi', 'credit specialist', 'loan consultant', 'credit officer', 'credit manager', 'kredit'],
        'legal_and_compliance' => ['legal', 'lawyer', 'юрист', 'contract', 'compliance', 'juridical', 'legal counsel', 'paralegal', 'policy'],
        'administration_and_office_support' => ['office manager', 'administrator', 'secretary', 'администратор', 'reception', 'executive assistant', 'office assistant', 'office coordinator', 'office operations'],
        'education_and_training' => ['teacher', 'tutor', 'trainer', 'coach', 'учитель', 'преподаватель', 'kurs', 'mentor', 'instructor', 'curriculum', 'edtech', 'ielts', 'ielts teacher', 'ielts tutor', 'ielts instructor', 'ielts coach'],
        'healthcare_and_medicine' => ['doctor', 'nurse', 'clinic', 'hospital', 'medical', 'shifokor', 'hamshira', 'paramedic', 'radiology', 'therapist', 'physiotherapy'],
        ...
        'logistics_and_supply_chain' => ['logistics', 'supply chain', 'логист', 'post', 'delivery', '3pl', 'freight', 'import', 'export', 'fleet', 'distribution'],
        'warehouse_and_procurement' => ['warehouse', 'storekeeper', 'клад', 'procurement', 'zakup', 'sotib olish', 'inventory', 'fulfillment', 'warehouse management'],
        'transportation_and_driving' => ['driver', 'driving', 'courier', 'delivery', 'водитель', 'haydovchi', 'dispatcher', 'fleet', 'chauffeur'],
        'customer_support_and_call_center' => ['support', 'customer service', 'call center', 'helpdesk', 'contact center', 'служба поддержки', 'customer care', 'ticketing'],
        'hospitality_and_tourism' => ['hospitality', 'hotel', 'tour', 'travel', 'гостиница', 'gid', 'concierge', 'front office', 'resort', 'booking', 'tourism manager', 'tour operator'],
        'food_and_beverage_service' => ['chef', 'cook', 'barista', 'waiter', 'кухня', 'oshpaz', 'bartender', 'restaurant', 'kitchen', 'culinary'],
        'retail_and_ecommerce' => ['retail', 'store', 'shop', 'магазин', 'cashier', 'e-commerce', 'online store', 'merchandiser', 'sales associate', 'pos', 'merchandising', 'директор магазина', 'продавец консультант', 'товаровед'],
        'real_estate' => ['real estate', 'realtor', 'broker', 'недвижимость', 'риэлтор', 'property manager', 'leasing', 'property advisor'],
        'beauty_and_personal_care' => ['beauty', 'cosmetologist', 'barber', 'hair', 'визаж', 'go\'zallik', 'makeup', 'lashes', 'nail', 'spa', 'esthetician'],
