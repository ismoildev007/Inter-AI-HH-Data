...
class VacancyCategoryService
{
    ...
    private array $keywordBuckets = [
        ...
        'it_and_software_development' => ['developer', 'programmer', 'software', 'dasturchi', 'разработчик', 'backend', 'frontend', 'fullstack', 'mobile', 'node', 'nestjs', 'express', 'spring boot', 'django', 'flask', 'laravel', 'symfony', 'rails', 'react', 'vue', 'angular', 'kotlin', 'swift', 'unity', 'unreal', 'golang', 'rust', 'typescript', 'salesforce', 'sap', '1c', 'shopify'],
        ...
        'video_and_multimedia_production' => ['video', 'motion', 'premiere', 'after effects', 'montaj', 'видео', 'davinci resolve', 'cinema 4d', 'blender', 'storyboard'],
        ...
        'retail_and_ecommerce' => ['retail', 'store', 'shop', 'магазин', 'cashier', 'e-commerce', 'online store', 'merchandiser', 'sales associate', 'pos', 'merchandising'],
