...
class VacancyCategoryService
{
    ...
    private array $keywordBuckets = [
        ...
        'logistics_and_supply_chain' => ['logistics', 'supply chain', 'логист', 'post', 'delivery', '3pl', 'freight', 'import', 'export', 'fleet', 'distribution', 'logistics coordinator', 'supply planner', 'dispatch', 'claims specialist', 'warehouse supervisor', 'customs', 'transport manager', 'route planner', 'shipping manager'],
