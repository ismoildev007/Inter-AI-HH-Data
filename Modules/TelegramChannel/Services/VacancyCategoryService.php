...
class VacancyCategoryService
{
    ...
    private array $keywordBuckets = [
        ...
        'banking_and_insurance' => ['bank', 'credit', 'loan', 'insurance', 'страхование', 'банк', 'microfinance', 'underwriting', 'fintech', 'payments', 'merchant'],
        ...
        'education_and_training' => ['teacher', 'tutor', 'trainer', 'coach', 'учитель', 'преподаватель', 'kurs', 'mentor', 'instructor', 'curriculum', 'edtech'],
