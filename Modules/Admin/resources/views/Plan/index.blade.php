...
<div class="plan-table card">
    ...
    @if($plans instanceof \Illuminate\Contracts\Pagination\Paginator || $plans instanceof \Illuminate\Contracts\Pagination\LengthAwarePaginator)
